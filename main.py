...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='path of /mimic/files/', help='the path to the directory containing the data.')
    parser.add_argument('--ann_path', type=str, default='path of annotation.json', help='the path to the directory containing the data.')
    ...
    parser.add_argument('-e','--epochs', type=int, default=5, help='the number of training epochs.')
