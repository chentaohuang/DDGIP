...
class AttModel(CaptionModel):
    ...
    #must add variables before state
    ...
    def _sample_beam(self, fc_feats, att_feats,embeddings,matrix, att_masks=None, opt={}):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks = self._prepare_feature(fc_feats, att_feats, att_masks,embeddings,matrix)
    ...
    def _sample(self, fc_feats, att_feats,embeddings,matrix, att_masks=None):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(fc_feats, att_feats,embeddings,matrix, att_masks, opt)
        if group_size > 1:
